...
async def start(bot, message):
    await message.reply(
        ...
        "**I am your Official MDisk Bot 🤗, Made by @MDiskofficial1Bot 💞 @MDiskofficial2Bot 💞 Send me a MDisk Post to see the Magic 😅**")
    
@bot.on_message(filters.text & filters.private)
async def Doodstream_uploader(bot, message):
    new_string = str(message.text)
    conv = await message.reply(" ✋ wait for a minutes ✋")
